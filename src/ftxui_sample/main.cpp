...
// configuration step. It creates a namespace called `othello`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", othello::cmake::project_name, othello::cmake::project_version) };
